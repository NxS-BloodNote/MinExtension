...
public class GolemSummoner extends BlockDirectional {
	...
	public IIcon getIcon(int p_149691_1_, int p_149691_2_) {
		return p_149691_1_ == 1 ? this.field_149984_b : (p_149691_1_ == 0 ? this.field_149984_b : (p_149691_2_ == 2 && p_149691_1_ == 2 ? this.field_149986_M
				: (p_149691_2_ == 3 && p_149691_1_ == 5 ? this.field_149986_M : (p_149691_2_ == 0 && p_149691_1_ == 3 ? this.field_149986_M
						: (p_149691_2_ == 1 && p_149691_1_ == 4 ? this.field_149986_M : this.blockIcon)))));
	}
	...
	public void onBlockAdded(World world, int posX, int posY, int posZ) {
		...
		if (world.getBlock(posX, posY - 1, posZ) == Blocks.iron_block && world.getBlock(posX, posY - 2, posZ) == Blocks.iron_block) {
			...
			if (flag || flag1) {
				...
				for (int l = 0; l < 120; ++l) {
					world.spawnParticle("snowballpoof", (double) posX + world.rand.nextDouble(), (double) (posY - 2) + world.rand.nextDouble() * 3.9D, (double) posZ + world.rand.nextDouble(), 0.0D,
							0.0D, 0.0D);
				}
